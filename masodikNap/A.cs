...
namespace AdventOfCode {
    internal class Program {
        ...
        static bool eldontes(string szam) {
            int len = szam.Length / 2;
            string a = szam[..len];
            string b = szam[len..];
            return a == b;
        }
        ...
        static void Bekeres(double kezdes,double veg) {
            for (double i = kezdes - 1; i < veg + 1; i++) {
        ...
        static void Main(string[] args) {
            ...
            string[] tartomanyok = cucc.Split(',', StringSplitOptions.RemoveEmptyEntries);
